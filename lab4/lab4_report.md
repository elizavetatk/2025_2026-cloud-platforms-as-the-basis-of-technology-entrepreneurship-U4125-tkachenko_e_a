...
| Cloud Run     | ~$5-80      |
| Vertex AI API | ~$5-10      |
| Cloud Run GPU | ~$400 (в продовом решении)|
| Cloud SQL    | ~$30-200     |

## Вывод
В результате работы была спроектирована архитектура и расчитаны расходы на ресурсы для AI-приложения для распознавания растений и животных по фото.
